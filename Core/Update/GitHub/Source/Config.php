    ...
    function __construct( $Location )
    {
        ...
        if (null !== $this->getProxyHost() && null !== $this->getProxyUser()) {
            $this->Network = Api::groupCore()->unitNetwork()->apiProxy()->apiType()->buildBasic(
                Api::groupCore()->unitNetwork()->apiProxy()->apiConfig()->buildServer( $this->getProxyHost(),
                    $this->getProxyPort() ),
                Api::groupCore()->unitNetwork()->apiProxy()->apiConfig()->buildCredentials( $this->getProxyUser(),
                    $this->getProxyPass() )
            );
        } else {
            if (null !== $this->getProxyHost()) {
